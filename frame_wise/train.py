...
def config_parser():
    ...
    parser.add_argument("--config-path", type=str, default='./configs/vit.yaml', help="path to config file")
...
def main():
    ...
    if phase == "pretrain":
        ...
        model = config.get_model(model_config, channels, num_classes - 2, height, width)
