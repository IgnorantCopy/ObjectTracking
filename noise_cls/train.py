...
def config_parser():
    ...
    parser.add_argument("--config-path", type=str, default='./configs/fc.yaml', help="path to config file")
...
def main():
    ...
    model = config.get_model(model_config, input_dim, num_classes)
    ...
    train_dataset = dataset.RDCol(train_paths)
    val_dataset = dataset.RDCol(val_paths)
